 ...
 * BThome V2 format on ESP32 (via NimBLE) and nRF52 (via Adafruit nRF52) platforms.
 */
 ...
 * 
 * Platform-specific implementations (ESP32, nRF52) should inherit from this class
 */
class BThomeV2 {
public:
    virtual ~BThomeV2() {}
     ...
     * @param event Event type (0x00=none, 0x01=press, 0x02=double_press, 0x03=triple_press, 0x80=long_press)
     */
